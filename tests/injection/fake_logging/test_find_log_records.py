...
def log_record(level, msg):
    return logging.LogRecord(
        name='spam', level=level, pathname='spam',
        lineno=1, msg=msg, args={}, exc_info=EndlessFake())
...
class TestFindLogRecords(TestCase):
    ...
    def test_finds_partial_text_on_partial_match(self):
        ...
        log.stored_records = [
            ...
            log_record(
                ...
                msg='heehaw')]
        expect(
            log.find_log_records(level=level, partial_text='lovely filth')).to(
    ...
    def test_finds_partial_text_on_full_match(self):
        ...
        log.stored_records = [
            ...
            log_record(
                ...
                msg=msg)]
        expect(
            log.find_log_records(level=level, partial_text=msg)).to(
    ...
    def test_returns_empty_when_no_text_matches(self):
        ...
        log.stored_records = [
            ...
            log_record(
                ...
                msg='heehaw')]
        expect(
            log.find_log_records(level=level, partial_text='lovely spam')).to(
            be_empty)
    ...
    def test_returns_empty_when_level_does_not_match(self):
        ...
        log.stored_records = [
            log_record(
                ...
                msg="There's some lovely filth down here!")]
        expect(
            log.find_log_records(
                level=logging.WARNING, partial_text='lovely')).to(
                be_empty)
    ...
    def test_ignores_level_when_unspecified(self):
        ...
        log.stored_records = [
            log_record(
                level=logging.INFO, msg="This is not a match"),
            log_record(
                level=logging.INFO,
                msg="There's some lovely filth down here!"),
            log_record(
                ...
                msg="There's some lovely filth down here!")]
        expect(
            log.find_log_records(partial_text='lovely')).to(
            equal(log.stored_records[1:]))
    ...
    def test_ignores_partial_text_when_unspecified(self):
        ...
        log.stored_records = [
            ...
            log_record(
                ...
                msg="There's some lovely filth down here!")]
        expect(
            log.find_log_records(level=logging.INFO)).to(
