...
from twin_sister.exceptions import ArgNotSpecified, FunctionNotCalled, KwargNotSpecified
...
class TestFunctionSpy(TestCase):
    ...
    def test_kwargs_from_last_call_complains_when_there_are_no_calls(self):
        expect(FunctionSpy().kwargs_from_last_call).to(complain(FunctionNotCalled))
    ...
    def test_args_from_last_call_complains_when_there_are_no_calls(self):
        expect(FunctionSpy().args_from_last_call).to(complain(FunctionNotCalled))
